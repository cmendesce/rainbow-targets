...
define boolean unhandledSuspicious = 1 > -1;
...
strategy HighTrafficStrategy
[ cHiRespTime ] {
  t0: (!cHiRespTime) -> addCaptcha () @[5000] {
    t0a: (default) -> TNULL;  // in this case, we have no more steps to take
  }
  t3: (default) -> TNULL;
}
